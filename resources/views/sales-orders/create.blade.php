...
@section('page-subtitle', 'Create a sales order for a customer')
@section('content')
<div class="max-w-3xl mx-auto">
    ...
    @if($customers->isEmpty())
        <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 text-center">
            <p class="text-amber-800 font-medium">No customers found</p>
            <a href="{{ route('customers.create') }}" class="mt-3 inline-block bg-amber-600 text-white px-5 py-2 rounded-xl text-sm font-medium">+ Add Customer First</a>
        </div>
    @else
        <form action="{{ route('sales-orders.store') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="customer_id" class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Stock Location *</label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                <div class="flex items-center justify-between border-b border-gray-100 pb-3 mb-5">
                    ...
                    <button type="button" id="add-item" class="bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-sm font-medium px-4 py-2 rounded-lg">+ Add Item</button>
                </div>
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('sales-orders.index') }}" class="text-sm text-gray-500 hover:text-gray-700">← Back</a>
