...
@section('page-subtitle', 'Update unit details')
@section('content')
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        <form action="{{ route('units.update', $unit) }}" method="POST" class="space-y-5">
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-2.5 rounded-xl text-sm">Update Unit</button>
            </div>
        </form>
    </div>
</div>
