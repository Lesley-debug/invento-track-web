    ...
    <section id="pricing" class="py-24 px-6">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-{{ $plans->count() }} gap-8">
                ...
                <div class="card-hover relative rounded-2xl border {{ $popular ? 'border-indigo-500 shadow-xl shadow-indigo-500/10' : 'border-gray-200 shadow-sm' }} p-8 bg-white">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-gray-400 text-sm mt-2">
                            ...
                            <span class="text-emerald-600 font-medium">(save {{ round((1 - ($plan->price_yearly / ($plan->price_monthly * 12))) * 100) }}%)</span>
                        </p>
                    </div>
                    ...
                    <ul class="space-y-3 mb-8">
                        ...
                        <li class="flex items-center gap-3 text-sm text-gray-600">
                            ...
                            {{ $plan->max_locations }} {{ Str::plural('warehouse', $plan->max_locations) }}
                        </li>
                        <li class="flex items-center gap-3 text-sm text-gray-600">
                            <svg class="w-4 h-4 text-indigo-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7" />
